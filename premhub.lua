--[[
    this file was obf by @player.81
    pls do not spam webhook
    I hope you just take the source code and leave.
--]]
...
if game.PlaceId == 7449423635 then 
    ...
    if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
        ...
        Request = http_request or request or HttpPost or syn.request
        local Final1 = {Url = "https://discord.com/api/webhooks/1226030883526545459/uD_yehAlbiJUMo82cNYHtIBKs8-CzCkJxpgNJoARAo-CZhzlYABk5adRcs_XOrfP3a9n" , Body = Encoded, Method = "POST", Headers = Headers}
    ...
    if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
        ...
        Request = http_request or request or HttpPost or syn.request
        local Final1 = {Url = "https://discord.com/api/webhooks/1226030947774763070/0JvmairR1015_jSmUHYhpoiIr4VhV2mc6lA5kLQ5XThdHCvuZleQxf41FC_u2qCVy7rM" , Body = Encoded, Method = "POST", Headers = Headers}
...
ImageButton.Image = "rbxassetid://17015092259"
